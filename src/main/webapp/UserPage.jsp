        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content rounded-4 border-0 shadow">
                ...
                <div class="modal-body p-4">
                    ...
                    <!-- code for open login auto and message  -->
                    
<%
    String loginRequired =
            request.getParameter("loginRequired");

    String medicineIdForLogin =
...
<div class="alert alert-warning d-flex align-items-center">
    ...
    <div>
        ...
        Please login first to buy this medicine.
    </div>
...
%>
    ...
    <body class="bg-light">
        ...
        <nav class="navbar navbar-expand-lg bg-white border-bottom sticky-top">
            <div class="container mt-3">
                ...
                <a class="navbar-brand fw-bold fs-4 text-primary" href="#">
                    <img src="extension/logo.png" alt="Dawa Wallah Logo" style="height:50px; width:auto;">

                    <span style="color:#003b8f; font-size:1.15em; font-weight:700;">दवा</span>
                    <span class="text-success">Wallah</span>
                ...
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="d-flex gap-2 flex-wrap mt-4">
                            ...
                            <a href="https://wa.me/918417919312?text=Hello%20दवा Wallah%2024%2F7%2C%20I%20need%20help"
                               target="_blank"
        ...
        "${pageContext.request.contextPath}/SearchMedi?name=" +
        ...
        // Enter key se bhi search
            ...
            //code for auto open page of login 
        <%
                String loginRequiredParam = request.getParameter("loginRequired");
        %>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // ==========================================
    // BUY NOW KE BAAD AUTO LOGIN
    // ==========================================

        <% if ("true".equals(loginRequiredParam)) { %>
